...
The `mnist_train.csv` file is not included in this repository because it exceeds GitHub's file size limit.

Please place the dataset inside the `data/` folder before running the project.
